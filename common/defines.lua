NDefines = {
  ...
  NDiplomacy = {
    ...
    HRE_VOTE_LEAGUE_LEADER = 200,
    HRE_VOTE_LEAGUE_LEADER_FRIEND = 300,
    HRE_VOTE_HERETIC = -50,
    HRE_VOTE_OVERLORD = 100,
    HRE_VOTE_VASSAL_ELECTOR = -50,
    HRE_VOTE_TOO_SMALL = -25,
    HRE_VOTE_BIG_COUNTRY = 100,
    HRE_VOTE_VERY_BIG_COUNTRY = 200,
    ...
    SPY_NETWORK_AE_EFFECT = -1,
    SPY_NETWORK_TECH_EFFECT = -0.1,
    SPY_NETWORK_TECH_EFFECT_MAX = -0.375,
  ...
  NMilitary = {
    ...
    REGULAR_LEADER_POWER = 1, -- Used for generals & admirals (affects total 12)
    ...
    CAVALRY_BREAKTHROUGH = 0.5, -- Between 0 and 1
    ...
    DAYS_PER_SIEGE_PHASE = 15, -- How many days each siege phase lasts
    COMBAT_DICE_SIDE = 6, -- How many sides the dice used in combat has
    BLOCKADE_FACTOR = 6, -- (Total sail speed / blockade_factor) * blockade_efficiency / province development
  ...
  NAI = {
    ...
    ARTILLERY_FRACTION = 0.8, -- Ratio of artillery to infantry AI will build
    ...
    COMBAT_PIP_IMPORTANCE = 1.44573, -- = (17/13)^(1/6)
    FIRE_PIP_MULT = 6, -- This means having one of each fire pip applies a modifier of 17/13 to the fire phase estimate, as desired (since it's equivalent to +1 dice modifier)
    SHOCK_PIP_MULT = 6, -- Ditto
    MORALE_PIP_MULT = 4, -- Morale pips are counted in both phases, but only applies to morale damage, which we guesstimate to be worth twice as much as casualties (=2/3, or ~1.32/2, of total)
  },
